...
class SkillBranch(Skill):
    ...
    * """
    ...
    def __init__(self, tolerance):
        super().__init__()
        self._skillRef = {}
        self._skillHub = SkillHubAlgDispenser()
        self._ml = AXLearnability(tolerance)
...
class DiSkillBundle(Skill):
    ...
    def manualAddResponse(self, key, value):
...
class GamiPlus(Skill):
    def __init__(self, skill, ax_gamification, gain):
        super().__init__()
        self.skill = skill
        self.ax_gamification = ax_gamification
        self.gain = gain
...
class GamiMinus(Skill):
    def __init__(self, skill, ax_gamification, cost):
        super().__init__()
        self.skill = skill
        self.ax_gamification = ax_gamification
        self.cost = cost
...
class DiGamificationSkillBundle(DiSkillBundle):
    def __init__(self):
        super().__init__()
        self.ax_gamification = AXGamification()
        self.gain = 1
        self.cost = 2
...
class DiGamificationScouter(Skill):
    def __init__(self, ax_gamification):
        ...
        self.lim = 2
        self.ax_gamification = ax_gamification
        self.no_mood = Responder("bored", "no emotions detected", "neutral")
        self.yes_mood = Responder("operational", "efficient", "mission ready", "awaiting orders")
